...
| ‍이름 | 담당 업무                                                                                                                                                           |
|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **김대호** | • 프로젝트 PM UI • 초안 스케치 및 화면 구조 설계|
| **김효성** | • 기본 화면 틀 완성 • 유저별 개인 서재 로그인 흐름 구현 및 도서 관리 UI 구현 • 프론트–백엔드 연동 시도 및 디버깅 • 검색 & 이미지 URL 저장 API 개발 <br>        |
| **이시연** | • User 도메인 설계 및 CRUD 구현                                                                                                                                         |
| **신준섭** | • User 도메인 설계 및 CRUD 구현
### 👨‍💼 김대호
1. **프로젝트 PM 역할 수행**
